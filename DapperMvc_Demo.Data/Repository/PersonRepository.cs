using DapperMvc_Demo.Data.DataAccess;
...
{
    public class PersonRepository:IPersonReposository
    {
        ...
        public async Task<bool> AddAsync(Person person)
        {
            try
            {
                await _db.SaveData("sp_create_person",
        ...
        public async Task<bool> DeleteAsync(int id)
        {
            try
            {
                await _db.SaveData("sp_delete_people",
                    new { Id=id });
